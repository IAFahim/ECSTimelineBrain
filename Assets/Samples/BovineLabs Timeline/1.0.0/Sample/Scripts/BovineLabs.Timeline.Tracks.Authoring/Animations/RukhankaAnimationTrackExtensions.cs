...
namespace BovineLabs.Timeline.Authoring
{
    ...
    {
        /// <summary>Resolves a RigDefinitionAuthoring from either a direct binding or a GameObject binding.</summary>
        ...
        /// <summary>Appends only valid (non-null) baked animation blob assets to the buffer.</summary>
