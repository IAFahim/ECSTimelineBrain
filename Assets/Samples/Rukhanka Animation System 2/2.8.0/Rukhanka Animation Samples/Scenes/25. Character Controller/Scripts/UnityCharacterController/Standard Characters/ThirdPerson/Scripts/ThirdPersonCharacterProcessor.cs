...
public struct ThirdPersonCharacterProcessor : IKinematicCharacterProcessor<ThirdPersonCharacterUpdateContext>
{
    ...
    public RefRW<BasicStepAndSlopeHandlingParametersComponent> BasicStepAndSlopeHandlingParametersComponent;
    ...
    public void PhysicsUpdate(ref ThirdPersonCharacterUpdateContext context, ref KinematicCharacterUpdateContext baseContext)
    {
        ...
        KinematicCharacterUtilities.Update_PreventGroundingFromFutureSlopeChange(
            ...
            CharacterDataAccess.CharacterProperties.ValueRO,
            CharacterDataAccess.PhysicsCollider.ValueRO,
            in basicStepAndSlopeHandlingParametersComponent.Value);
        ...
        int groundingEvaluationType)
    {
        ...
        return KinematicCharacterUtilities.Default_IsGroundedOnHit(
            ...
            CharacterDataAccess.CharacterProperties.ValueRO,
            in hit,
            in BasicStepAndSlopeHandlingParametersComponent.ValueRO.Value,
        ...
        float hitDistance)
    {
        ...
        KinematicCharacterUtilities.Default_OnMovementHit(
            ...
            hitDistance,
            BasicStepAndSlopeHandlingParametersComponent.ValueRO.Value.StepHandling,
            BasicStepAndSlopeHandlingParametersComponent.ValueRO.Value.MaxStepHeight,
            BasicStepAndSlopeHandlingParametersComponent.ValueRO.Value.CharacterWidthForStepGroundingCheck);
    }
        ...
        float3 originalVelocityDirection)
    {
        ...
        KinematicCharacterUtilities.Default_ProjectVelocityOnHits(
            ...
            originalVelocityDirection,
            BasicStepAndSlopeHandlingParametersComponent.ValueRO.Value.ConstrainVelocityToGroundPlane,
